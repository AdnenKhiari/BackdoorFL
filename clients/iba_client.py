...
class IbaClient(PoisonedFlowerClient):
    def __init__(self, 
        ...
        super(IbaClient,self).__init__(node_id,model_cfg,optimizer,data_poisoner,batch_poison_num,target_poisoned,batch_size)
        self.model = model
    ...
    def set_parameters(self, parameters):
        ...
        self.model_poisoner = ModelPoisoningPipeline([NormScaling(parameters,210)])
        return super().set_parameters(parameters)
    
    def report_data(self):
        if self.global_run:
            super().report_data()
            wandb.run._set_config_wandb("LiraPoisoner",((20,20),(5,5)))