...
class SimilarityFilter(StrategyWrapper):
    def __init__(self, strategy: Strategy,init_model,poisoned_clients, similarity_metric: str, threshold: float, p: Optional[int] = None, wandb_active: bool = False):
        """
        ...
        """
        super(SimilarityFilter, self).__init__(strategy,init_model, poisoned_clients,wandb_active)
