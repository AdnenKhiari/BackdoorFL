...
class RFLBATWrapper(StrategyWrapper):
    def __init__(self, strategy: Strategy, model_cfg,poisoned_clients, epsilon1: float = 10, epsilon2: float = 4, num_sampling: int = 5, K_max: int = 10, wandb_active=False):
        super().__init__(strategy, model_cfg,poisoned_clients, wandb_active)
